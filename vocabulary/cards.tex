...
\begin{printdemosample} \index{use}  \index{discover}\index{continent} \index{anyway} \index{honest} \index{honestly} \index{earlier} \index{stuff}
 I use scissors.
