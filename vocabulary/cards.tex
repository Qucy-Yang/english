...
\begin{tikzpicture} \index{wood} \index{wooden} \index{blood}\index{flood} \index{consider} \index{formal} \index{sugar} \index{thumb} \index{warn} \index{suggest} \index{metal} \index{attractive} \index{attraction} \index{gorgeous} \index{arrest} \index{attack} \index{crime} \index{criminal} \index{ruin} \index{ruinous}
  \coordinate  (p1) at (0, 1);
  \coordinate  (p2) at (0, 0);
  \coordinate  (p3) at (0, -1);
  \coordinate  (p4) at (5, 1);
