...
#    __DEBUG = True
    ...
    __simple_list = [
      "a", "about", "after", "all", "am", "an", "and", "any", "are", "aren't", "as", "ask", "at", "at all",
      "bad", "ball", "be", "bed", "big", "bird", "book", "box", "boy", "bring", "bus", "busy", "but", "buy", "by",
      "cake", "can", "car", "cat", "classroom", "clean", "close", "cold", "cool", "come", "cut",
      "dad", "dance", "day", "do", "does", "dog", "down", "did", "draw",
      "eat", "egg", "every", "English",
      "fast", "father", "find", "fish","five", "fly", "foot", "football", "for", "from",
      "get", "girl", "give",  "go", "good", "green",
      "happy", "hand", "has", "have", "he", "help", "her", "here", "him", "his", "home", "hot", "hour", "how",
      "if", "in", "is", "isn't", "it", "I",
      "jump", "just",
