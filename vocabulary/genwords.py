...
#    __DEBUG = True
    ...
    __simple_list = [
      "a", "able", "about", "after", "all", "also", "am", "an", "and", "any", "are", "aren't", "as", "ask", "at", "a few", "at all",
      "bad", "ball", "be", "bed", "big", "bird", "book", "box", "boy", "bring", "bus", "busy", "but", "buy", "by", "by car",
      ...
      "take", "tell", "ten", "than", "thank you", "that", "the", "there", "there are", "there is", "these", "they", "think", "this", "those", "time", "to", "today", "too", "tooth", "tree", "two",
      "up", "us", "use",
      "very",
