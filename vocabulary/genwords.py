...
#    __DEBUG = True
    ...
    __simple_list = [
      "a", "all", "am", "an", "and", "any", "are", "aren't", "as", "at",
      "bad", "big", "book", "box", "boy", "bus", "but", "busy", "buy", "by",
      "can", "clean", "cold", "come", "cut",
      "day", "do", "does", "dog", "down", "did", "draw",
      "egg", "every",
      "fast", "father", "find", "five", "fly", "for", "from",
      "get", "girl", "go", "good", "green",
      "happy", "has", "have", "he", "his", "hot", "how",
      "if", "in", "is", "isn't", "I",
      "jump",
      "leg", "like", "listen", "little", "look", "long",
      "man", "me", "morning", "mother", "my", "Miss Thin", "Mr Chan", "Mrs Ship",
      "name", "new", "no", "not",
      "of", "off", "old", "on", "one", "open", "our", "out",
      "pen", "play", "please", "put",
      "quick", "quickly",
      "read", "red", "right", "run",
      "school", "see", "she", "should", "sister", "six", "slow", "slowly","so", "some","stop",
      "than", "that", "the", "there are", "there is", "they", "this", "time", "to", "too", "two",
      "up",
      "very",
      "was", "water", "we", "what", "when", "who", "why", "will", "with", "woman", 
      "yes", "you", "your",
    ]
